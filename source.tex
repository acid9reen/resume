...
\begin{paracol}{2}
	...
	% Name & headline
	\heading{Руслан Смирнов}{Python Разработчик}
	...
	\begin{supertabular}{ll}
		\footnotesize\faPhone & +7 905 865 0428\\
		\footnotesize\faEnvelope & \href{mailto:ruslan.ol.smirnov@yandex.ru}{ruslan.ol.smirnov@yandex.ru} \\
		\footnotesize\faTelegram & \href{https://t.me/ruslan\_ol\_smirnov}{@ruslan\_ol\_smirnov} \\
	...
	\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
		...
		\item Дипломная работа: ``Анализ существующих подходов детектирования сердечно-сосудистых заболеваний по записям ЭКГ с использованием глубоких нейронных сетей. Конструирование нового подхода в виде другой архитектуры нейронной сети''
	\end{itemize}
	...
	\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
		...
		\item Кафедра: Алгебры, Геометрии и Дискретной Математики
		\item Дипломная работа: ``Улучшение методики анализа ЭГ с помощью глубокого обучения''
	\end{itemize}
